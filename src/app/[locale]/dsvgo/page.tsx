...
function DSVGO() {
  return (
    <div className="flex flex-col items-center bg-primary text-secondary md:text-lg p-4 space-y-4">
      ...
      <p>
        Wir nutzen den Dienst Google Calendar der Google Ireland Limited, Gordon
        House, Barrow Street, Dublin 4, Irland (&bdquo;Google&ldquo;), zur
        Verwaltung von Terminen und Verf&uuml;gbarkeiten.{" "}
      </p>
      ...
      <p>
        ...
        ist. Weitere Informationen zur Datenverarbeitung durch Google findest du
        in der Datenschutzerkl&auml;rung von Google:{" "}
        <a
