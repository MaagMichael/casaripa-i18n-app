...
function DSVGO() {
  return (
    <div className=" bg-primary text-secondary ">
      <div className="mx-auto max-w-[1024px] flex flex-col items-center md:text-lg p-4 space-y-4">
        <p>
          Download here:{" "}
          <span>
            <a
        ...
        <p>
          Telefon: 0049 179 294 64 32
          <br />
          E-Mail: casaripa.cupra@gmail.com
        </p>
        <p>
        ...
        <p>
          Wir nutzen den Dienst Google Calendar der Google Ireland Limited,
          Gordon House, Barrow Street, Dublin 4, Irland (&bdquo;Google&ldquo;),
          zur Verwaltung von Terminen und Verf&uuml;gbarkeiten.{" "}
        </p>
        <p>Zweck der Verarbeitung</p>
        <p>
          Die Nutzung von Google Calendar erfolgt zur effizienten Terminplanung
          und Organisation von Verf&uuml;gbarkeiten, Meetings oder anderen
          Terminen.{" "}
        </p>
        <p>Rechtsgrundlage</p>
        <p>
          Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO,
          sofern die Terminvereinbarung zur Erf&uuml;llung eines
          Vertragsverh&auml;ltnisses erforderlich ist. In anderen F&auml;llen
          erfolgt die Verarbeitung auf Basis unseres berechtigten Interesses
          gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO an einer effizienten
          Organisation und Verwaltung von Terminen.
        </p>
        <p>Daten&uuml;bermittlung in Drittl&auml;nder</p>
        <p>
          Google speichert und verarbeitet Daten m&ouml;glicherweise auch in den
          USA. Google ist jedoch durch den EU-U.S. Data Privacy Framework
          zertifiziert, sodass ein angemessenes Datenschutzniveau sichergestellt
          ist. Weitere Informationen zur Datenverarbeitung durch Google findest
          du in der Datenschutzerkl&auml;rung von Google:{" "}
          <a
        ...
        <p>Speicherdauer</p>
        <p>
          Die Daten bleiben so lange im Google Calendar gespeichert, wie es zur
          Erf&uuml;llung des Zwecks erforderlich ist oder gesetzliche
          Aufbewahrungspflichten bestehen.{" "}
        </p>
        <p>Widerspruchsrecht</p>
        <p>
          Du kannst der Verarbeitung deiner Daten widersprechen, sofern die
          Verarbeitung nicht zur Vertragserf&uuml;llung notwendig ist. In diesem
          Fall kann die Nutzung von Google Calendar f&uuml;r dich jedoch
          eingeschr&auml;nkt oder nicht m&ouml;glich sein.{" "}
        </p>
        <p>Weitere Informationen</p>
        <p>
          Wenn du nicht m&ouml;chtest, dass deine Daten von Google verarbeitet
          werden, kannst du uns alternativ &uuml;ber andere Kommunikationswege
          kontaktieren (z. B. per E-Mail oder Telefon).
        </p>
        <h3>Google Maps</h3>{" "}
        <p>
          ...
          Street, Dublin 4, Irland. Mit Hilfe dieses Dienstes k&ouml;nnen wir
