...
function Impressum() {
  return (
    <div className="flex flex-col items-center bg-primary text-secondary md:text-lg p-4 space-y-4">
      <h1 className="text-xl md:text-4xl font-bold ">Impressum</h1>
      ...
      <div className=" text-lg md:text-xl space-y-4">
        ...
        <div>
          ...
          <p>Contrada Ripa, 9</p>
          <p>60034 Cupramontana AN, Italy</p>
        </div>
        <p>Vertreten durch:</p>
        <div>
        ...
        <p>Kontakt:</p>
        <div>
          <p>Telefon: (0049) 179 294 64 32</p>
          <p>E-Mail: casaripa.cupra(at)gmail.com</p>
          <p>Internet: www.casaripa.com</p>
        </div>
        <p>Registereintrag:</p>
        <div>
          <p>Italien:</p>
